// Import only TypeScript types from shared schema (not Drizzle table definitions)
import type { 
  User, InsertUser, Category, InsertCategory, 
  Product, InsertProduct, Address, InsertAddress,
  CartItem, InsertCartItem, Order, InsertOrder,
  ...
  EmailSubscription, InsertEmailSubscription,
  PurchaseIntent, InsertPurchaseIntent
} from "@shared/schema";
...
export interface IStorage {
  ...
  updatePurchaseIntentAddress(id: string, shippingAddress: any, email: string, phone: string): Promise<any>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updatePurchaseIntentAddress(id: string, shippingAddress: any, email: string, phone: string): Promise<PurchaseIntent | undefined> {
    const [intent] = await db.update(purchaseIntents)
      .set({ 
        shippingAddress,
        email,
