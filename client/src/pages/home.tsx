          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <p className="text-primary font-medium tracking-wider uppercase text-sm">Curated Collection</p>
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-lg" data-testid="hero-description">
                  Transform your space with our carefully selected furniture pieces. Each item combines exceptional craftsmanship with contemporary design.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                <img
                  ...
                  alt="Modern living room with curated furniture pieces"
      ...
      <section className="py-16 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-serif font-semibold text-foreground mb-4">Why Choose Furnish</h3>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">We're committed to bringing you the finest furniture with exceptional service at every step of your journey.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group" data-testid="feature-shipping">
              ...
              <h3 className="text-xl font-serif font-semibold mb-3">White Glove Delivery</h3>
              <p className="text-muted-foreground leading-relaxed">Professional delivery and setup service for all furniture pieces over $500</p>
            </div>
            <div className="text-center group" data-testid="feature-security">
              <div className="bg-secondary group-hover:bg-primary group-hover:text-primary-foreground text-secondary-foreground rounded-2xl w-20 h-20 flex items-center justify-center mx-auto mb-6 transition-all duration-300">
                <Shield className="h-10 w-10" />
              </div>
              <h3 className="text-xl font-serif font-semibold mb-3">Quality Guarantee</h3>
              <p className="text-muted-foreground leading-relaxed">Every piece comes with our lifetime quality guarantee and 30-day return policy</p>
            </div>
            <div className="text-center group" data-testid="feature-support">
              <div className="bg-secondary group-hover:bg-primary group-hover:text-primary-foreground text-secondary-foreground rounded-2xl w-20 h-20 flex items-center justify-center mx-auto mb-6 transition-all duration-300">
                <Headphones className="h-10 w-10" />
              </div>
              <h3 className="text-xl font-serif font-semibold mb-3">Design Consultation</h3>
              <p className="text-muted-foreground leading-relaxed">Free interior design consultation to help you create your perfect space</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
              Discover furniture pieces tailored to every space in your home
            </p>
          </div>
          ...
          {categories.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground text-lg">Loading room collections...</p>
            </div>
          ) : (
                  ...
                  <Card className="furniture-card group cursor-pointer text-center h-full overflow-hidden" data-testid={`category-${category.slug}`}>
                    ...
                    <CardContent className="p-8">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Explore our curated {category.name.toLowerCase()} collection
                      </p>
